...
- **Qual problema ele resolve:** dá aos alunos um ponto único de consulta para os slides das aulas, na ordem correta do conteúdo, facilitando a revisão de tópicos específicos antes de provas, listas de exercícios e trabalhos.
...
|  04  | Isomorfismos e subgrafos                   | [Ver slides](./slides/04-isomorfismos-subgrafo.pdf)                  |
...
|  21  | Coloração: algoritmo guloso e Welsh-Powell | [Ver slides](./slides/21-colaracao-guloso-welsh-powell.pdf)          |
...
│   └── icons/         # 💡 Ícones de contato usados na seção de autor.
│
...
- **Prof. Dr. Gabriel Barbosa**: por todo o ensino ao longo da disciplina de Teoria dos Grafos e Computabilidade, pela disponibilidade e pela cessão do material de **Dijkstra** disponibilizado neste repositório.
...
Os slides e demais materiais didáticos aqui reunidos permanecem de autoria dos respectivos professores e são disponibilizados exclusivamente para fins de estudo dos alunos da disciplina.
